...
function setup(){
  ...
  sword=createSprite(width/2,height/2,100,100)
...
sword.y=World.mouseY
 ...
 text("Score: "+ score,width-100,height-600);
...
function fruit1(){
   var fruit1=createSprite(600,Math.round(random(30,width-50)),10,10)
...
function fruit2(){
   var fruit2=createSprite(600,Math.round(random(30,width-50)),10,10)
...
function fruit3(){
   var fruit3=createSprite(600,Math.round(random(30,width=50)),10,10)
...
function fruit4(){
   var fruit4=createSprite(600,Math.round(random(30,width-50)),10,10)
